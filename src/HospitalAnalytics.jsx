    ...
    <div className="h-full flex flex-col gap-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-10">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div className="xl:col-span-2 bg-white rounded-[32px] p-8 shadow-sm border border-gray-50 flex flex-col">
          ...
          <div className="flex-1 flex items-end justify-between gap-4 mt-8 min-h-[250px]">
            {monthlyData.map((data, idx) => (
              <div key={idx} className="flex flex-col items-center flex-1 gap-4 group h-full">
                <div className="w-full bg-gray-50 rounded-t-xl relative flex items-end justify-center group-hover:bg-gray-100 transition-colors flex-1">
                  <motion.div 
                    initial={{ height: 0 }}
